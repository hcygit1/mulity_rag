 ...
 */
export async function getChatHistory(conversationId = null) {
  try {
    const params = conversationId ? { conversation_id: conversationId } : {}
    const response = await httpClient.get('/api/llm/history', params)
    return response
  } catch (error) {
 ...
 */
export async function getChatHistoryTitles() {
  try {
    const response = await httpClient.get('/api/llm/history/titles')
    return response
  } catch (error) {
