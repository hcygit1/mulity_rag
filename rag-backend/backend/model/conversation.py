...
class Conversation(Base):
    ...
    summary_updated_at = Column(DateTime, nullable=True, comment='摘要最后更新时间')
    ...
    def to_dict(self):
        return {
            ...
            'summary_updated_at': to_china_time(self.summary_updated_at).isoformat() if self.summary_updated_at else None
        }